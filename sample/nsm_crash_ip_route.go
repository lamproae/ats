...
func main() {
	...
	for net := 0; net <= 2000000; net++ {
		c.RunCommand(cli.Command{"config", "ip route 23.2.2.0/24 100.1.1.2", "#"})
		<-ticker.C
		c.RunCommand(cli.Command{"config", "ip route 23.2.2.0/24 2.1.1.2", "#"})
		<-ticker.C
		c.RunCommand(cli.Command{"config", "no ip route 23.2.2.0/24 2.1.1.2", "#"})
		c.RunCommand(cli.Command{"config", "no ip route 23.2.2.0/24 130.1.1.254", "#"})
		<-ticker.C
		c.RunCommand(cli.Command{"config", "no ip route 23.2.2.0/24 100.1.1.2", "#"})
		<-ticker.C
		c.RunCommand(cli.Command{"config", "ip route 23.2.2.0/24 130.1.1.254", "#"})
		<-ticker.C
